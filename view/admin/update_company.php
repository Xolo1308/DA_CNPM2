...
$sql_select = "
    SELECT company_id, name, email, password, role 
    FROM companies 
    WHERE company_id = ?
";
...
if (mysqli_num_rows($result_select) === 0) {
    echo "<script>alert('Không tìm thấy tài khoản công ty!'); window.location.href='list_company.php';</script>";
    exit();
}
...
<div class="content-wrapper">
    ...
    <div class="wrapper wrapper-content">
        <div class="container mt-4">
            <h2 class="mb-3">📝 Chỉnh sửa tài khoản Công ty (ID: <?= $user_data['company_id'] ?>)</h2>
            
            <?= $message ?> <form method="POST" action="">
                
                <div class="mb-3">
                    <label for="name" class="form-label">Họ và tên/Tên công ty:</label>
                ...
                <a href="list_company.php" class="btn btn-secondary">Quay lại danh sách</a>
            </form>
        </div>
    </div>
</div>